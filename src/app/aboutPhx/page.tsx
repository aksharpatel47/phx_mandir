    ...
    <>
      <div className="text-white bg-[#0000008a] p-8 text-[18px]">
        <p>
          ...
          spirituality. Visitors and devotees come to mandir to offer prayers
          before the murtis, or sacred images, as well as to attend cultural
          classes and religious services known as sabhas. BAPS Swaminarayan
          mandirs serve to both foster and further personal and collective
          worship. Pramukh Swami Maharaj, the spiritual leader and guru to BAPS,
          supports the establishment of mandirs as a means to cultivate peace
          within communities and connect individuals to Bhagwan.{" "}
        </p>
        <p>
          Mandirs represent a Vedic tradition of building, maintaining, and
